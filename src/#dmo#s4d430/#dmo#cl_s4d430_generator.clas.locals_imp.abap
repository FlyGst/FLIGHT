...
CLASS lcl_generator_depment_rel DEFINITION INHERITING FROM lcl_generator.
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS c_tabname TYPE tabname VALUE '/DMO/DEPMENT_REL'.


    CONSTANTS c_dep1 TYPE /DMO/department_id VALUE 'SALE'.
    CONSTANTS c_dep2 TYPE /DMO/department_id VALUE 'ADMIN'.
    ...
    DATA departments TYPE TABLE OF /DMO/depment_rel READ-ONLY.
...
CLASS lcl_generator_employ_root DEFINITION ABSTRACT INHERITING FROM lcl_generator.
  ...
  PROTECTED SECTION.
    ...
    CLASS-DATA raw_data TYPE TABLE OF /DMO/employ_ext.
...
CLASS lcl_generator_employ DEFINITION INHERITING FROM lcl_generator_employ_root.
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS c_tabname TYPE tabname VALUE '/DMO/EMPLOY'.
    ...
    DATA employees TYPE TABLE OF /DMO/employ READ-ONLY.
...
CLASS lcl_generator_employ_dep DEFINITION INHERITING FROM lcl_generator_employ_root.
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS c_tabname TYPE tabname VALUE '/DMO/EMPLOY_DEP'.
    ...
    DATA employees TYPE TABLE OF /DMO/employ_dep READ-ONLY.
...
CLASS lcl_generator_employ_rel DEFINITION INHERITING FROM lcl_generator_employ_root.
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS c_tabname TYPE tabname VALUE '/DMO/EMPLOY_REL'.
    ...
    DATA employees TYPE TABLE OF /DMO/employ_rel READ-ONLY.
...
CLASS lcl_generator_employ_ext DEFINITION INHERITING FROM lcl_generator_employ_root.
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS c_tabname TYPE tabname VALUE '/DMO/EMPLOY_EXT'.
    ...
    DATA employees TYPE TABLE OF /DMO/employ_ext READ-ONLY.
