CLASS /DMO/cl_s4d430_tys_table_type DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
**********************************************************************
*    TYPES tt_addresses TYPE SORTED TABLE OF /DMO/s_address
...
CLASS /DMO/CL_S4D430_TYS_TABLE_TYPE IMPLEMENTATION.
...
*    DATA addresses TYPE tt_addresses.
    DATA addresses TYPE /DMO/t_addresses.
...
*    DATA person TYPE st_person_deep.
    DATA person TYPE /DMO/s_person_deep.
...
*    DATA persons TYPE tt_persons.
    DATA persons TYPE /DMO/t_persons.
