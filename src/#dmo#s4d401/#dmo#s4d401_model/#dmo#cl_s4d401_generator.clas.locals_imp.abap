...
CLASS lcl_generator_airport DEFINITION INHERITING FROM lcl_generator.
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS c_tabname TYPE tabname VALUE '/DMO/AIRPORT'.
    ...
    DATA airports TYPE TABLE OF /DMO/airport READ-ONLY.
...
CLASS lcl_generator_passflight DEFINITION INHERITING FROM lcl_generator.
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS c_tabname TYPE tabname VALUE '/DMO/PASSFLIGHT'.
    ...
    DATA flights TYPE TABLE OF /DMO/passflight READ-ONLY.
...
CLASS lcl_generator_cargoflight DEFINITION INHERITING FROM lcl_generator.
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS c_tabname TYPE tabname VALUE '/DMO/CARGOFLIGHT'.
    ...
    DATA flights TYPE TABLE OF /DMO/cargoflight READ-ONLY.
